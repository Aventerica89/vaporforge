...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Analyze multiple files from the workspace using Google Gemini. Reads files from disk and sends them to Gemini 2.0 Pro for cross-file analysis.',
    inputSchema: {
      type: 'object',
      properties: {
