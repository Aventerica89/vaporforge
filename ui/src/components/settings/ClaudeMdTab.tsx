  ...
  return (
    <div className="flex h-full flex-col gap-3">
      ...
      <textarea
        ...
        className="flex-1 min-h-[480px] w-full resize-y rounded-lg border border-border bg-muted p-3 font-mono text-xs text-foreground placeholder:text-muted-foreground/50 focus-visible:border-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
        spellCheck={false}
      />
