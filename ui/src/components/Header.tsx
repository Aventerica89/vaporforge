          ...
          {editingName && currentSession ? (
            ...
            >
              <input
                ...
                className="w-[140px] sm:w-[180px] rounded border border-primary/50 bg-background px-2 py-0.5 text-base font-mono focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                style={{ fontSize: '16px' }}
