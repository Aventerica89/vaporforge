...
Ideas and future directions captured during development sessions.
One file per idea — use `git blame` to see when each was added.
...
**Filename convention:** `kebab-case-short-title.md`

**Front matter (top of file):**
```
**Added:** YYYY-MM-DD
**Status:** Idea | In Progress | Done
**Category:** VaporForge / <subcategory>
```
