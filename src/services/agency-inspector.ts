...
const INSPECTOR_LINES: string[] = [
  ...
  '      d.style.cssText="all:initial;display:block;position:absolute;inset:0;"',
  '        +"border:"+b+";border-radius:3px;background:"+bg+";box-sizing:border-box;"',
  ...
  '      var d=document.createElement("div");',
  '      d.style.cssText="all:initial;display:inline-block;background:rgba(168,85,247,.9);"',
  '        +"color:#fff;font:11px/1.2 system-ui,sans-serif;padding:2px 6px;"',
